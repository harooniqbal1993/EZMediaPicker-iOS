...
public class MediaPickerManager : NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    public func pickImage(viewController: UIViewController, mediaType: MediaType, completion: @escaping (UIImage?, URL?, String?) -> Void) {
